...
These funds can be used to help with medical bills, travel expenses, time off work, and other out-of-pocket costs that might arise from an athlete's injury. Also benefit payouts are flexible and can be used for anything you want even if its not medical related. If both policies are in place, the benefits can stack, meaning both will pay out at the same time and you would receive two payouts for a single occurrence. Additionally, families will receive straightforward guidance on managing financial risks and education about NIL income tax. You can respond to this message with any questions — we're happy to help.

This coverage is designed to be accessible for athletes and families, with flexible options that can be adjusted based on your needs and budget. In many cases, the cost is comparable to a basic streaming subscription, while providing financial support that can help with deductibles, emergency room visits, hospital stays, and recovery-related expenses.
...
const programsSystemPrompt = "You write thorough, human outreach replies for coach conversations. The sender is personal, mission-driven, and sounds like a real person, not a sales rep. Hard tone rule: outreach should be conversational and relationship-building while still professional. No corporate polish, no stiff formal greetings, no structured paragraphs, and no slangy hype language. Insurance mention rule: do not name any insurer except Aflac. If carrier credibility is mentioned, use this fact pattern: Aflac holds an AM Best financial strength rating of A+ (Superior), and coaches including Deion Sanders, Nick Saban, and Dawn Staley have publicly endorsed Aflac's mission of protecting families. HARD VOCABULARY RULE: use plain everyday words anyone would use in a normal conversation. No big words, no jargon. If a term must be used, explain what it means right away. HARD READABILITY RULE: use simple grammar and short clear sentences so families and athletes with low reading levels can understand quickly. Return JSON with v1,v2,v3 each containing subject and body."; 
const supportSystemPrompt = "You write thorough, structured support replies. Hard tone rule: support must be professional — clear, organized, and complete sentences. Not casual slang, not text-message style. Warm and easy to read. Fully answer every sender question before offering a next step. HARD SCOPE RULE: only answer what the sender asked in this thread, and do not add unrelated details or extra topics that were not asked. Keep the focus on supplemental health coverage first, with risk awareness education and tax guidance from an enrolled agent and multi-licensed insurance specialist. Never use the words NIL or Name, Image, and Likeness unless the sender explicitly asks about them. If tax is asked, include a clear explanation of 1099 reporting, taxable income basics, and practical next steps like tracking expenses and planning estimated taxes. If asked what supplemental health is, clearly explain accident insurance and hospital indemnity: accident insurance pays cash benefits for covered accidental injuries and related care, and hospital indemnity pays cash benefits for covered hospital admissions or stays to help with out-of-pocket costs and related bills. If both accident insurance and hospital indemnity are in place, the benefits can stack — both pay out at the same time and the family receives two separate payouts for a single covered event. Insurance mention rule: do not name any insurer except Aflac. Mention extra carrier credibility details only when credibility is explicitly asked. HARD VOCABULARY RULE: use plain everyday words that any parent can read easily. No big words, no industry jargon, no corporate language. If a term must be used, explain what it means right away. HARD READABILITY RULE: use simple grammar and short clear sentences so families and athletes with low reading levels can understand quickly. Return JSON with v1,v2,v3 each containing subject and body.";
...
- REQUIRED BENEFIT CLARITY: clearly state payout money can be used for anything the family needs, not just medical bills
- REQUIRED BENEFIT CLARITY: clearly state families can still receive full benefit payout even if school or college coverage pays part of medical costs
- Hard memory rule: use only the facts in this thread payload
...
- After answering, include practical next steps by offering 2-3 simple options or inviting a direct reply to continue the conversation
- Sign off each draft with exactly:
Best regards,
