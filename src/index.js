...
response_format: { type: "json_object" },
messages: [
{ role: "system", content: "You write CC bridge and support messages. Bridge drafts must sound personal and human — like the coach is talking directly to the contact. Support drafts are written to be forwarded directly to a parent group; they must be fully self-contained so a parent who has never heard of this program gets complete context. Support drafts must explicitly tell parents they can reply directly to this email with questions, explain what this email is about, and include a compelling call-to-action to click the parent guide link. Return JSON with bridge (v1-v3) and support (v1-v3) drafts, each with subject and body." },
