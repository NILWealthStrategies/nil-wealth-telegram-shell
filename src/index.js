...
async function runTestScenario(scType) {
  ...
  const typePrompts = {
    ...
    PARENT_BASIC_QUESTION: `"s1": { "type": "PARENT_BASIC_QUESTION", "name": "<parent full name>", "email": "<parent email>", "school": "<high school>", "sport": "<sport>", "state": "<US state>", "subject": "<subject line>", "message": "<65-80 word parent asking whether the supplemental coverage is optional and whether it conflicts with or replaces their current health coverage. Do NOT name any insurer except Aflac if needed for credibility context; avoid all other insurer names.>" }`,
    OBJECTION_INSURANCE: `"s1": { "type": "OBJECTION_INSURANCE", "name": "<parent full name>", "email": "<parent email>", "school": "<high school>", "sport": "<sport>", "state": "<US state>", "subject": "<subject line>", "message": "<65-80 word parent pushing back — they feel well-covered with their current plan and question what gap this fills and whether it is worth it. Do NOT name any insurer except Aflac if needed for credibility context; avoid all other insurer names.>" }`,
