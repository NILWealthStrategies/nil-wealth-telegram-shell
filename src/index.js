...
${officialWebsiteLink}`.trim();
  ...
  const privacySafeSupportByVersion = {
    v1: [
      ...
      "To help with this, supplemental health coverage is available. It works alongside your primary insurance and pays you directly if your child gets injured. The money can be used however you need - for medical bills or anything else your family needs. Families can still receive the full benefit payout even if school or college coverage pays part of medical costs. The goal is to help you feel more prepared and avoid added financial stress during recovery.",
    ...
    v2: [
      ...
      "Supplemental health coverage is available to help with that gap. It works alongside your primary insurance and pays you directly if your child gets injured. Those funds can be used for medical bills or anything else your family needs, and families can still receive the full benefit payout even if school or college coverage pays part of medical costs. This helps families feel more prepared during recovery.",
    ...
    v3: [
      ...
      "Supplemental health coverage is one way to help close those gaps. It works with your primary insurance and pays you directly if your child gets injured. Families can use that money for medical bills or anything else they need, and families can still receive the full benefit payout even if school or college coverage pays part of medical costs. This helps reduce financial stress during recovery.",
