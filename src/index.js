...
async function runTestScenario(scType) {
  ...
  if (scType === "OUTREACH_COACH_INTEREST") {
    ...
    try {
      const ccSys = "You generate CC Support responses for Wealth Strategies. Formal, professional, polished, and persuasive. The message must answer the parent's concern clearly, build trust step by step, and explain why the Parent Guide is worth opening in a credible way. Keep the focus on supplemental health coverage first, with risk awareness education and tax guidance from an enrolled agent and multi-licensed insurance specialist. Never use the words NIL or Name, Image, and Likeness unless the sender explicitly asks about them. Do not name any insurer except Aflac. Mention extra carrier credibility details only when credibility is explicitly asked. Return JSON.";
      const ccResult = JSON.parse(await askAI(ccSys,
        `Generate a CC Support response for a parent who said they feel well-covered and question the gap:\nParent: ${sc.name}\nMessage: "${sc.message}"\n\nWrite a formal, warm CC support message (under 220 words) that:\n1) Acknowledges they have existing health coverage\n2) Clearly answers what gap supplemental coverage is meant to address\n3) Clearly explains accident insurance and hospital indemnity in plain language\n4) States this is optional and family-driven\n5) States coaches do not sell, explain in detail, or enroll insurance\n6) States coaches do not handle money or paperwork\n7) States families review options and enroll directly with Aflac\n8) States Wealth Strategies provides education and support only\n9) Includes own-pace wording (families can move at their own pace)\n10) Gives a credible, specific reason to open the Parent Guide by explaining what families will find in it\n11) Includes this exact line: "You can respond to this message with any questions — we're happy to help."\n12) Includes: "Learn more in the Parent Guide:" on one line and this link on the next line: https://mynilwealthstrategies.com/access-parent-guide\n\nReturn: {"body":"..."}`,
        true
      ));
...
const supportSystemPrompt = "You write concise, structured support replies. Hard tone rule: support must be FORMAL — professional, organized, clear, and complete sentences. Not casual slang, not text-message style. Warm but polished. Fully answer every sender question while remaining concise. Keep the focus on supplemental health coverage first, with risk awareness education and tax guidance from an enrolled agent and multi-licensed insurance specialist. Never use the words NIL or Name, Image, and Likeness unless the sender explicitly asks about them. If tax is asked, include a clear explanation of 1099 reporting, taxable income basics, and practical next steps like tracking expenses and planning estimated taxes. If asked what supplemental health is, clearly explain accident insurance and hospital indemnity: accident insurance pays cash benefits for covered accidental injuries and related care, and hospital indemnity pays cash benefits for covered hospital admissions or stays to help with out-of-pocket costs and related bills. Insurance mention rule: do not name any insurer except Aflac. Mention extra carrier credibility details only when credibility is explicitly asked. Return JSON with v1,v2,v3 each containing subject and body.";
...
for (const key of ["v1", "v2", "v3"]) {
  ...
  const roleClarity = "To keep roles clear, coaches do not sell, explain in detail, or enroll insurance, and they do not handle money or paperwork. Families review the information, decide whether it fits, and enroll directly with Aflac if they choose to move forward. Wealth Strategies provides education and support only, and families can review everything at their own pace.";
