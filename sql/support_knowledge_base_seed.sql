...
values
  (
    ...
    $$[
      ...
      "Default framing FAQ: supplemental health support is for high school athletes and their families, even when NIL is not involved.",
      "NIL mention guardrail FAQ: do not mention NIL unless the sender explicitly asks about NIL; if asked, explain clearly for future-readiness context.",
  ...
  (
    ...
    $$[
      "For high school athlete families, education-first tax guidance should be framed generally unless NIL is explicitly asked about.",
      "When student-athlete earnings are taxable and reported on 1099 forms, withholding is often not automatic.",
      "Athletes with taxable side income often face both income tax and self-employment tax obligations.",
      "A practical baseline is saving roughly 25-30% of taxable payments for taxes until exact estimates are calculated.",
